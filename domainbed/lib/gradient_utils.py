...
def simple_sum(domain_grads):
    """ Simple summation consensus strategy. """
...
# def monte_carlo(distribution, neighborhood_size, criterion, iterations=100):
#     """
#     Monte Carlo simulation and selection of the optimum path.
#
#     Parameters
#         :param distribution:
